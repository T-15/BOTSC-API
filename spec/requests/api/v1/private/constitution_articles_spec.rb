...
RSpec.describe "/api/v1/private/constitution_articles", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get api_v1_private_constitution_articles_url, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested constitution_article" do
      constitution_article = ConstitutionArticle.create! valid_attributes
      expect {
        delete api_v1_private_constitution_article_url(constitution_article), headers: valid_headers, as: :json
      }.to change(ConstitutionArticle, :count).by(-1)
    end
  end
end
