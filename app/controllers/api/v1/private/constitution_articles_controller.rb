class Api::V1::Private::ConstitutionArticlesController < ApplicationController
  before_action :set_constitution_article, only: [:show, :update, :destroy]

  # GET api/v1/private/constitution_articles
  def index
  ...
  # GET api/v1/private/constitution_articles/1
  def show
    render json: @constitution_article
  end

  # POST api/v1/private/constitution_articles
  def create
    @constitution_article = ConstitutionArticle.new(constitution_article_params)

    if @constitution_article.save
      render json: @constitution_article, status: :created, location: api_v1_private_constitution_article_path(@constitution_article)
    else
      render json: @constitution_article.errors, status: :unprocessable_entity
    end
  end

  # PATCH/PUT api/v1/private/constitution_articles/1
  def update
  ...
  # DELETE api/v1/private/constitution_articles/1
  def destroy
